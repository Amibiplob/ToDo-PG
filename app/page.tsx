      ...
      <section className="container mx-auto px-4 py-24">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
            A secure, modern Todo application powered by PostgreSQL, Neon
            Database, NextAuth, and Server Actions.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-16 text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              Modern architecture with secure authentication and powerful
              database support.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Create, update, complete, and delete tasks effortlessly.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Password hashing with bcrypt and session management using
                  NextAuth.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <h3 className="mb-2 text-xl font-semibold">PostgreSQL</h3>

                <p className="text-muted-foreground">
                  Store user accounts and todos securely in Neon PostgreSQL.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="mx-auto max-w-4xl bg-primary text-primary-foreground">
            <CardContent className="flex flex-col items-center p-12 text-center">
              ...
              <p className="mb-8 max-w-xl opacity-90">
                Organize your work, track progress, and stay focused with your
                personal todo dashboard.
              </p>

              {session?.user ? (
                <Button size="lg" variant="secondary" asChild>
                  <Link href="/todos">Open My Todos</Link>
                </Button>
              ) : (
                <Button size="lg" variant="secondary" asChild>
